...
export function getReportCompanyName() {
  if (typeof window === 'undefined') return REPORT_COMPANY_NAME_FALLBACK;
  return localStorage.getItem('sys_company_name') || REPORT_COMPANY_NAME_FALLBACK;
}
...
function makePdf(title, headers, rows) {
  ...
  function startPage() {
    ...
    commands.push(drawCenteredText(meta.title, y - 18, { font: 'F2', size: 11 }));
    commands.push('0.38 0.44 0.53 rg');
    commands.push(drawCenteredText(`Generated: ${meta.generatedAt} | Generated By: ${meta.generatedBy} | Rows: ${rows.length}`, y - 34, { size: 8 }));
    y -= 56;
